...
// prerequisites
$lang['admin']['s0:title'] = 'Install ' . app()->config('application_name') . ' - Prerequisites';
...
$lang['admin']['s1:title'] = 'Install ' . app()->config('application_name') . ' - Step One';
...
$lang['admin']['s1b:title'] = 'Install ' . app()->config('application_name') . ' - Create Configuation File';
...
$lang['admin']['success:link'] = 'Begin using ' . app()->config('application_name');
