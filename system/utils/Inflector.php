	...
	function &getInstance() {
		...
		if (!$instance) {
			$instance[0] = new Inflector();
				$instance[0]->__pluralRules = array();
				$instance[0]->__uninflectedPlural = array();
				$instance[0]->__irregularPlural = array();
				$instance[0]->__singularRules = array();
				$instance[0]->__uninflectedSingular = array();
				$instance[0]->__irregularSingular = array();
		}
		return $instance[0];
	}
/**
 ...
 */
	function __initPluralRules() {
		...
		$pluralRules = Utils::pushDiff($this->__pluralRules, $corePluralRules);
		$uninflected = Utils::pushDiff($this->__uninflectedPlural, $coreUninflectedPlural);
		$irregular = Utils::pushDiff($this->__irregularPlural, $coreIrregularPlural);
 ...
 */
	function __initSingularRules() {
		...
		$singularRules = Utils::pushDiff($this->__singularRules, $coreSingularRules);
		$uninflected = Utils::pushDiff($this->__uninflectedSingular, $coreUninflectedSingular);
		$irregular = Utils::pushDiff($this->__irregularSingular, $coreIrregularSingular);
