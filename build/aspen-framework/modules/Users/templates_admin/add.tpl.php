<h2><?php print $this->text('userform:addtitle'); ?></h2>
...
<form method="post" action="<?php print $this->createFormAction(); ?>">
	<fieldset>
		...
		<input type="password" id="password" name="password" value="<?php print $values['password'] ?>" class="text" />
		</p>
		
		<p>
		<label for="password_confirm"><?php print $this->text('userform:confirm'); ?>:</label><br />
		<input type="password" id="password_confirm" name="password_confirm" value="<?php print $values['password_confirm'] ?>" class="text" />
		</p>
	...
	<fieldset>
		...
		<p><input type="submit" name="submit" value="<?php print $this->text('userform:addbutton'); ?>" /></p>
	</fieldset>
</form>